...
contract RubleCoin {
    ...
    string public name = "RubleCoin";
    string public symbol = "RUB";
    uint256 public max_supply = 2231979336291100000000000000000000000056982222222222222223555555555555411111111;
    uint256 public unspent_supply = 1;
    uint256 public spendable_supply = 100;
    uint256 public circulating_supply = 2231979336291100000000000000000000000056982222222222222223555555555555411111111;
    uint256 public decimals = 2;
    uint256 public reward = 2231979336291100000000000000000000000056982222222222222223555555555555411111111;
    ...
    function updateSupply() internal returns (uint256) {
      ...
      if (now - timeOfLastHalving >= 5 minutes) {
        reward /= 2;
        timeOfLastHalving = now;
      }
    ...
    function mint() public payable {
        ...
        uint256 _value = msg.value / 10000;
